---
title: "What We Learned From the First MySQL Ecosystem Spotlight"
description: "A recap of our first conference booth at Percona Live Amsterdam — the MySQL Ecosystem Spotlight — and what five ecosystem projects taught us about visibility and getting involved."
date: 2026-09-16
tags:
- Recap
author: "Maria Nesterova"
author_page: "/resources/member-directory/maria-nesterova"
image: "cover.jpg"
hero_image: false
---
...
<figure>
  <img src="booth-setup.jpg" alt="The OurSQL Foundation booth at Percona Live Amsterdam, with a roll-up banner reading 'The vendor-neutral home for MySQL' next to a table of flyers and stickers.">
...
- **dbtrail** — time-travel for MySQL and PostgreSQL, so a bad UPDATE becomes a two-minute fix instead of a disaster. Founder: [Daniel Guzmán Burgos](/resources/member-directory/people/daniel-guzman-burgos/).
- **MyVector** — a MySQL plugin for vector similarity search, built for semantic search and AI apps, no external service needed. Founder: [Alkin Tezuysal](/resources/member-directory/people/alkin-tezuysal/).
- **AliSQL** — an open source MySQL branch from Alibaba Cloud with built-in analytics, vector indexes, and flashback. Founder: [Zongzhi Chen](/resources/member-directory/people/zongzhi-chen/).
- **MySQL Advisor** — paste your MySQL config, get a prioritized review, 148 checks, no database connection needed. Founder: [Kedar Vaijanapurkar](/resources/member-directory/people/kedar-vaijanapurkar/).
- **HammerDB** — open source benchmarking across MySQL and several other databases. Founder: [Steve Shaw](/resources/member-directory/people/steve-shaw/).

<figure>
  <img src="booth-demo.jpg" alt="A presenter gesturing at a screen showing the dbtrail dashboard at the shared conference booth.">
...
The biggest thing we took away came from one question we kept hearing: people kept stopping to ask [Vadim Tkachenko](/resources/member-directory/people/vadim-tkachenko/), the Foundation President, "How can I get involved? What do you want me to do?" That's a good problem — people are ready to contribute, they just don't know where to start. Making that clear is our job now.
...
<figure>
  <img src="flyers.jpg" alt="Flyers reading 'The Future of MySQL is Shared' stacked on the booth table, with QR codes to suggest a resource and join the Slack.">
